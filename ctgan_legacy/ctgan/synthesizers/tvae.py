...
from ._utils import _set_device, validate_and_set_device
...
class TVAE(BaseSynthesizer):
    ...
    @random_state
    def fit(self, train_data, discrete_columns=(), save_dir=None):
        ...
        for i in iterator:
            ...
            epoch_loss_total = epoch_loss / len(loader)
            ...
            wandb.log({"loss":epoch_loss_total}, step=i)
